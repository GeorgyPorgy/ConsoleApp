...
namespace J2534
{
    public interface IPassThru : IDisposable
    {
        ...
        /// <summary>
        /// Read single message and indications from the receive buffer.
        /// </summary>
        ...
        /// <param name="pFlowControlMsg"> For FlowControl filters, points to the CAN ID used for segmented sends and receives.</param>
